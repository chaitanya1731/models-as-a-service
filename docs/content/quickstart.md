...
=== "Operator (Recommended)"
    ...
    ```bash
    export MAAS_REF="v0.3.0-test"  # Use the latest release tag, or "main" for development
    ...
    !!! note "Using Release Tags"
        ...
        The release workflow automatically updates all `MAAS_REF="v0.3.0-test"` references in documentation and scripts
